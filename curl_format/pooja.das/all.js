...
return new Promise((resolve, reject) => {
    fetch("https://www.instagram.com/api/v1/friendships/6830917098/followers/?count=12&search_surface=follow_list_page", {
    "headers": headers,
    "method": "GET"
    })
...
function fetchFollowers(max_id) {
    return new Promise((resolve, reject) => {
      fetch("https://www.instagram.com/api/v1/friendships/6830917098/followers/?count=12&max_id=" + max_id + "%3D%3D&search_surface=follow_list_page", {
        "headers": headers,
        "method": "GET"
      })
        .then(response => response.json())
